<p align="center">
    ...
    <br>      
    <p align="center">
      具有2600套成品系统，包括ssm项目，springboot项目，小程序项目，同时提供设计文档、PPT资料等<br><br>
...
### 3基于springboot的汽车租赁管理系统 拥有三种角色：管理员、用户、业务员
...
### 5基于springboot和vue的在线漫画系统3拥有两种角色
...
### 8基于springboot和vue的线上买菜系统拥有两种角色
...
### 9基于springboot的学生选课管理系统11拥有三种角色
...
### 10基于springboot的学生选课管理系统 拥有三种角色
...
### 11基于springboot的充电桩管理系统 拥有三种角色：管理员、用户和维修人员
...
### 15基于springboot的口腔管理系统拥有两种角色：管理员和用户
...
### 16基于springboot的图书馆座位预约管理系统2拥有三种角色
...
### 17基于springboot和VUE的医院管理系统9拥有三种角色
...
### 21基于springboot和vue的宿舍管理系统11有三种角色
...
### 22基于springboot和vue的实验室管理系统2拥有两种角色
...
### 23基于springboot和vue的学生管理系统17拥有三种角色：管理员、教师、学生。管理员可以自行设置多种角色多种菜单权限。
...
### 24基于springboot的大学生综合成绩管理系统3拥有三种角色
...
### 30基于springboot的垃圾分类管理系统2拥有两种角色
...
### 31基于springboot的新闻管理系统5拥有两种角色：管理员和用户
